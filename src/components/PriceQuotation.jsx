...
function PriceQuotation({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col bg-white">
            ...
            <div className="flex items-center px-4 py-3 bg-white">
                ...
                <span className="text-xl font-bold flex-1 text-center">入仓出价</span>
            ...
            <div className="p-4 grid grid-cols-2 gap-4 bg-white">
                <button className="bg-teal-400 text-white py-3 px-6 rounded-lg text-lg">
                    一键出价
                </button>
